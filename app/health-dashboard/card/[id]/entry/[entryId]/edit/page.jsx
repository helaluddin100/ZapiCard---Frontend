      ...
      <DashboardLayout>
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Edit Health Entry</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {validationErrors.doctor_name && (
                    <p className="mt-1 text-sm text-red-600">{validationErrors.doctor_name[0]}</p>
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  {validationErrors.doctor_specialty && (
                    <p className="mt-1 text-sm text-red-600">{validationErrors.doctor_specialty[0]}</p>
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div>
              ...
              {validationErrors.recommendations && (
                <p className="mt-1 text-sm text-red-600">{validationErrors.recommendations[0]}</p>
              )}
            </div>
