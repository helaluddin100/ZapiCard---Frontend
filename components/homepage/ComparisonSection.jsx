...
export default function ComparisonSection() {
    ...
    return (
        <section className="py-16 md:py-28 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50/50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    >
                        <span className="px-4 sm:px-6 py-2 sm:py-2.5 rounded-full bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:from-blue-900/30 dark:via-purple-900/30 dark:to-pink-900/30 text-blue-700 dark:text-blue-300 text-xs sm:text-sm md:text-base font-semibold border-2 border-blue-200 dark:border-blue-800 shadow-sm">
                ...
                <div className="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12 md:mb-16">
                    ...
                    >
                        <div className="relative h-full p-6 sm:p-8 md:p-10 bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl border-2 border-gray-200 dark:border-gray-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-gray-300 dark:hover:border-gray-600">
                            {/* Card Header */}
                            <div className="text-center mb-6 md:mb-10">
                                <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl md:rounded-3xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 mb-4 md:mb-6 shadow-lg">
                                    <FileText className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-gray-600 dark:text-gray-400" />
                                </div>
                                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2 md:mb-3">
                                    Traditional Cards
                                </h3>
                    ...
                    >
                        ...
                        {/* Main Card */}
                        <div className="relative h-full p-6 sm:p-8 md:p-10 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-2xl md:rounded-3xl border-2 border-purple-400 shadow-2xl transform md:scale-105 hover:scale-[1.06] transition-all duration-500 overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="text-center mb-6 md:mb-10">
                                    <motion.div
                                        ...
                                        className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl md:rounded-3xl bg-white/20 backdrop-blur-md mb-4 md:mb-6 shadow-2xl border-2 border-white/30"
                                    >
