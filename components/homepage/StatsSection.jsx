    ...
    return (
        <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent px-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                    {stats.map((stat, idx) => (
                        ...
                        >
                            ...
                            {/* Card */}
                            <div className="relative text-center p-4 sm:p-6 md:p-8 lg:p-10 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all border-2 border-gray-200 dark:border-gray-700 group-hover:border-purple-300 dark:group-hover:border-purple-700">
                                {/* Number with gradient - No icons! */}
                                <div className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-3 bg-gradient-to-r ${stat.color} bg-clip-text text-transparent`}>
                                    {stat.number}
                                </div>

                                {/* Label */}
                                <div className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 dark:text-gray-400 font-medium">
                                    {stat.label}
                                </div>
                            </div>
                        </motion.div>
